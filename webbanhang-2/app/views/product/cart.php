    ...
    <?php if (!empty($cart)): ?>
        <div class="card shadow-lg border-light">
            <div class="card-body">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="row w-100">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-muted mb-1">Giá: <?php echo number_format($item['price'], 0, ',', '.'); ?> VND</p>
                                    
                                    <!-- Quantity Update Form -->
                                    <div class="d-flex align-items-center">
                                        <a href="/Product/updateCart/<?php echo $id; ?>?action=decrease" class="btn btn-outline-secondary btn-sm" title="Giảm số lượng">-</a>
                                        <span class="mx-2"><?php echo htmlspecialchars($item['quantity'], ENT_QUOTES, 'UTF-8'); ?></span>
                                        <a href="/Product/updateCart/<?php echo $id; ?>?action=increase" class="btn btn-outline-secondary btn-sm" title="Tăng số lượng">+</a>
                                    </div>
                                </div>

                                <!-- Remove Button -->
                                <div class="col-md-3 text-center">
                                    <a href="/Product/remove/<?php echo $id; ?>" class="btn btn-danger btn-sm mb-2" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');" title="Xóa sản phẩm">Xóa</a>
                                </div>
                            </div>
                        </li>
                    <?php endforeach; ?>
                ...
                <div class="total-amount mt-4 text-left">
                    <h3 class="font-weight-bold">Tổng tiền: 
